...
var builder = new ReopenUrlBuilder("https:\/\/www.tradeadexchange.com\/a\/display.php?r=2135171&treqn=391425415&runauction=1&crr=8969236373704b8a14bb,,gj63epnuq5taaoka6psaavn66utGqvnWqj63uj63ei73Ou8yLo94ee6187cc232612caed&rtid=5c07cf1cbaa5b");
var url = builder.build();

    var content = '<iframe width="728" height="90" marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" allowfullscreen="true" style="border: medium none; padding: 0; margin: 0;" sandbox="allow-scripts allow-forms allow-popups allow-popups-to-escape-sandbox allow-pointer-lock allow-same-origin" id="5c07cf1cbaa5b"  frameborder="0" src="'+ url +'" scrolling="no"></iframe>';
    ...
    if ((browser.chrome && browser.major_version < 17) || browser.opera_mini) {
        document.getElementById('5c07cf1cbaa5b').removeAttribute('sandbox');
    }
